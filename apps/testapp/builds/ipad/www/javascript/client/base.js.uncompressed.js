...
if(!dojo._hasResource["toura.xhr"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource['toura.components.AdTag']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
dojo.declare('toura.components.AdTag', mulberry._Component, {
  templateString : dojo.cache("toura.components", "AdTag/AdTag.haml", ".component.ad-tag\n  %iframe{ dojoAttachPoint : 'adFrame' }\n"),
...
if(!dojo._hasResource['toura.UI']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource['toura.Analytics']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource['toura.Bootstrapper']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource['toura.URL']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource['toura.Data']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource['toura.Manifest']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource['toura.Routes']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
    ...
    function nodeRoute(route, nodeId, pageState) {
      ...
      if (!page || !page.node || nodeId !== page.node.id) {
        ...
        try {
          ...
          console.error("toura.Routes: can't create a page", e, nodeModel);
...
if(!dojo._hasResource['toura.user.Facebook.android']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource['toura.user.Facebook.ios']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource['toura.user.Facebook.browser']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource['toura.user.Facebook.base']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource['toura.user.Twitter']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
dojo.declare('toura.user.Twitter', null, {
  ...
  _postMessage : function(msg, t) {
    ...
    var postRequest = new toura.user._TwitterAPI({
  ...
  _getAuth :  function() {
    ...
    authRequest = new toura.user._TwitterAPI({
      customerKey : this.twitterConfig.customerKey,
      consumerSecret : this.twitterConfig.customerSecret
    });
...
if(!dojo._hasResource['toura.Sharing']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
dojo.declare('toura.capabilities.Page_GoogleMapTablet', mulberry._Capability, {
  requirements : {
    googleMap : 'GoogleMap',
    pinInfo : 'PinInfo'
  },
...
dojo.declare('toura.capabilities.Page_FullScreenImages', mulberry._Capability, {
  requirements : {
...
dojo.declare('toura.capabilities.ImageGallery_ImageCaption', mulberry._Capability, {
  requirements : {
    imageGallery : 'ImageGallery',
    imageCaption : 'ImageCaption'
  },
...
dojo.declare('toura.capabilities.FeedItemList_FeedItemDetail', mulberry._Capability, {
  requirements : {
    feedItemList : 'FeedItemList',
...
dojo.declare('toura.capabilities.Page_Audios', mulberry._Capability, {
  requirements : {
...
dojo.declare('toura.capabilities.Page_Videos', mulberry._Capability, {
  requirements : {
...
dojo.declare('toura.capabilities.Page_Search', mulberry._Capability, {
  requirements : {
...
dojo.declare('toura.components.AppNav', mulberry._Component, {
...
dojo.declare('toura.components.AssetList', mulberry._Component, {
...
dojo.declare('toura.components.BodyText', mulberry._Component, {
  ...
  _handleClick : function(e) {
    ...
    if (/^http/.test(href)) {
      ...
      mulberry.app.PhoneGap.browser.url(href);
      return;
    }
  },
...
dojo.declare('toura.components.HeaderImage', mulberry._Component, {
  ...
  setupConnections : function() {
    ...
    if (origImage.destination) {
      this.connect(this.domNode, 'click', function() {
        mulberry.app.PhoneGap.browser.url(origImage.destination);
      });
    }
  },
...
dojo.declare('toura.components.DetailTitle', mulberry._Component, {
...
dojo.declare('toura.components.Hotspots', mulberry._Component, {
  ...
  _handleImageClick : function(e) {
    ...
    if (foundSpot) {
      ...
      mulberry.app.Router.go(toura.URL.node(foundSpot.node_id));
    }
  },
...
dojo.declare('toura.components._ImageGallery', null, {
  ...
  _setupClick : function() {
    ...
    var events = mulberry.app.UI.hasTouch ? {
      start : 'touchstart',
      move : 'touchmove',
      end : 'touchend'
    } : {
    ...
    this.connect(this.clickNode, events.start, function() {
      ...
      c.push(dojo.connect(this.imageList, events.end, function(e) {
        ...
        if ((new Date().getTime() - start > mulberry.app.UI.touchMoveDebounce) && moved) { return; }
        handle(e);
      }));
    });
  }
...
if(!dojo._hasResource['toura.user.Favorites']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
dojo.declare('toura.components.SocialMessage', mulberry._Component, {
  ...
  _handleErrors : function(errors) {
    mulberry.app.PhoneGap.notification.alert(errors.join('\n'));
  },
...
dojo.declare('toura.components.PinInfo', mulberry._Component, {
  ...
  setupConnections : function() {
    this.connect(this.websiteContainerNode, 'click', function(e) {
      e.preventDefault();
      mulberry.app.PhoneGap.browser.url(dojo.attr(this.websiteContainerNode, 'data-url'));
    });
  },
...
dojo.declare('toura.components.SearchInput', mulberry._Component, {
...
dojo.declare('toura.components.SearchResults', mulberry._Component, {
...
if(!dojo._hasResource['mulberry.ui.PinchZoom']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['mulberry.ui.PinchZoom'] = true;
dojo.provide('mulberry.ui.PinchZoom');



dojo.declare('mulberry.ui.PinchZoom', null, {
  zoomMax : 3,
  ...
  _makeScroller : function(listItem) {
    ...
    this.scroller = new iScroll(listItem, {
      zoom : mulberry.app.Has.iScrollZoom(),
      onZoomEnd : function() {
  ...
  onZoomEnd : function(bgImageWidget, scroller) {
    ...
    this.zoomTimeout = setTimeout(dojo.hitch(this, function() {
      ...
      if (bgImageWidget.imageWidth > bgImageWidget.imageHeight) {
        if (newWidth < mulberry.app.UI.viewport.width) {
          newWidth = mulberry.app.UI.viewport.width;
          newHeight = newWidth / ratio;
        }
      } else {
        if (newHeight < mulberry.app.UI.viewport.height) {
          newHeight = mulberry.app.UI.viewport.height;
          newWidth = newHeight * ratio;
        }
      }

      if (newWidth > mulberry.app.UI.viewport.width * this.zoomMax) {
        newWidth = oldWidth;
        newHeight = oldHeight;
        newX = newY = 0;
      }
...
dojo.declare('toura.components.ZoomableImageGallery', [ mulberry._Component, toura.components._ImageGallery, mulberry.ui.PinchZoom ], {
...
if(!dojo._hasResource['client.components.ATestComponent']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['client.components.ATestComponent'] = true;
dojo.provide('client.components.ATestComponent');

mulberry.component('ATestComponent', {
  componentTemplate : dojo.cache("client.components", "ATestComponent/ATestComponent.haml", ".component.a-test-component It works!\n"),
...
dojo.i18n._preloadLocalizations("client.nls.base", ["ROOT","en","en-us","xx"]);
